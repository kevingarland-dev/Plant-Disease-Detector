    ...
    <div className="predict-root">
      ...
      <div className="predict-hero">
        ...
        <p className="predict-subtitle">
          Upload a high-resolution photo of your plant's foliage. Our neural networks identify 17 specific botanical pathogens and conditions with clinical accuracy.
        </p>
      </div>
      ...
      <div className="predict-upload-container">
        ...
        <div className="predict-side-badges">
          ...
          <div className="predict-badge">
            <span className="badge-dot orange"></span> LIBRARY 17 CLASSES
          </div>
        </div>
