        ...
        <div className="hero-columns">
          ...
          <ScrollReveal delay={200}>
            <div className="hero-col">
              ...
              <p>Upload a high-resolution photo of your plant's foliage. Our neural networks identify 17 botanical diseases and health conditions across corn, potato, and tomato crops with clinical accuracy. Ensure the vitality of your crops by catching diseases before they spread.</p>
            </div>
          </ScrollReveal>
        </div>
      </section>
